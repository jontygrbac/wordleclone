...
function Board() {
    ...
    <div className='board'>
        <div className='row'>
            ...
            <Letter letterPosition={6} attemptVal={0}/> 
        </div>
        <div className='row'>
            ...
            <Letter letterPosition={6} attemptVal={1}/> 
        </div>
        <div className='row'>
            ...
            <Letter letterPosition={6} attemptVal={2}/> 
        </div>
        <div className='row'>
            ...
            <Letter letterPosition={6} attemptVal={3}/> 
        </div>
        <div className='row'>
            ...
            <Letter letterPosition={6} attemptVal={4}/> 
        </div>
        <div className='row'>
            ...
            <Letter letterPosition={6} attemptVal={5}/> 
        </div>
    </div>
    );
}
